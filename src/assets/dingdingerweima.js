      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          if (data.code === '0') {
            ...
            // console.log(data)
            // JSON.stringify({ jobnumber: data.result.jobnumber, userName: data.result.name, avatar: data.result.avatar, isSysAdmin: data.result.isSysAdmin, id: data.result.id })
            window.localStorage.setItem('userInfos', JSON.stringify(data.result))
